        ...
        return Response({
            ...
            'api_endpoints': {
                ...
                'business114': {
                    ...
                    'endpoints': [
                        {'method': 'GET', 'path': '/api/v1/business114/', 'description': '사업장 목록 조회'},
                        {'method': 'POST', 'path': '/api/v1/business114/', 'description': '사업장 등록'},
                        {'method': 'GET', 'path': '/api/v1/business114/{id}/', 'description': '사업장 상세 조회'},
                        {'method': 'GET', 'path': '/api/v1/business114/search/', 'description': '사업장 검색'},
                    ]
                },
                'recruitment': {
